...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    social_profile: Schema.Attribute.String;
...
export interface ApiLibraryContentLibraryContent
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    descriptionLong: Schema.Attribute.Text;
    cover: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'> &
      Schema.Attribute.Required;
    author: Schema.Attribute.Relation<'oneToOne', 'api::author.author'>;
    body: Schema.Attribute.DynamicZone<
      ['shared.media', 'shared.actions', 'shared.slider']
    >;
    duration: Schema.Attribute.Component<'shared.duration', false>;
    likeCount: Schema.Attribute.BigInteger & Schema.Attribute.DefaultTo<'0'>;
    tileType: Schema.Attribute.Enumeration<
      ['large-tile', 'standard-tile', 'narrow-tile', 'long-tile']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'standard-tile'>;
    seo: Schema.Attribute.Component<'shared.seo', false> &
      Schema.Attribute.Required;
    type: Schema.Attribute.Enumeration<['article', 'audio', 'video']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'article'>;
    points: Schema.Attribute.Component<'shared.points', false>;
...
export interface ApiMobileContentFilterMobileContentFilter
  ...
  attributes: {
    filters: Schema.Attribute.Component<'shared.filter-tags', true>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiMobileLibraryMobileLibrary extends Struct.SingleTypeSchema {
  ...
  attributes: {
    sections: Schema.Attribute.Component<'shared.library-section', true> &
...
export interface ApiOrganisationOrganisation
  ...
  attributes: {
    ...
    orgId: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
    description: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    accent: Schema.Attribute.Enumeration<['accent-1', 'accent-2', 'accent-3']>;
    libraryContents: Schema.Attribute.Relation<
      'manyToMany',
      'api::library-content.library-content'
    >;
...
export interface ApiUserLikeUserLike extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    createdAt: Schema.Attribute.DateTime;
    libraryContent: Schema.Attribute.Relation<
      'manyToOne',
      'api::library-content.library-content'
    > &
      Schema.Attribute.Required;
    userId: Schema.Attribute.UID & Schema.Attribute.Required;
    orgId: Schema.Attribute.UID & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
